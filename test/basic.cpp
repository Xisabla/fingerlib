...
TEST(Basic, HeaderFingerprint) {
    ...
    HTTPRequest req("/WebGoat/registration", "GET", "1.1", headers);

    auto fp = fingerprint(req);

    STRCMP_EQUAL("1.3|2|1.0|||||GE|1|ho,co,pr,ca-co,u-i-r,us-ag,ac,1586472b,7e369551,a602679,"
                 "206f7215,975a9022,re,ac-en,ac-la,ck|co:ke-al/ca-co:nc/us-ag:92028000/ac:f159e9d0/"
                 "ac-en:gz,de,br/ac-la:b88ab870|||",
                 fp.c_str());
}
